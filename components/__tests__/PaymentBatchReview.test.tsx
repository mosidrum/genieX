...
const worklog3: Worklog = {
  id: 'w-3',
  taskName: 'Backend Work',
  freelancerId: 'f-2',
  status: 'pending',
};

// Alice w-1: 4h * $100 = $400
const entries1: TimeEntry[] = [{ id: 'e-1', worklogId: 'w-1', date: '2025-12-01', hoursWorked: 4 }];
// Alice w-2: 6h * $100 = $600
const entries2: TimeEntry[] = [{ id: 'e-2', worklogId: 'w-2', date: '2025-12-02', hoursWorked: 6 }];
// Bob w-3: 8h * $50 = $400
const entries3: TimeEntry[] = [{ id: 'e-3', worklogId: 'w-3', date: '2025-12-03', hoursWorked: 8 }];
